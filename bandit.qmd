...
```{r}
run_simulation("0.22 0.21 0.215 0.2175 0.19 0.36 0.215 0.2 0.15 0.22 50000 oracle", "bandits.csv")
```

```{r}
probs <- "0.22 0.21 0.215 0.2175 0.19 0.23 0.215 0.2 0.15 0.22"
samples <- "50000"
...
system(paste("./target/release/bandit", probs, samples, " epsilon 0.05 > epsilon.csv"))
